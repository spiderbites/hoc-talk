      ...
      <Spectacle theme={theme}>
        <Deck transition={['zoom', 'slide']} transitionDuration={500}>
          ...
          <Slide transition={['fade']}>
            ...
            <BlockQuote>
              <Quote textColor="black" textSize={54}>
                Decorators are "are functions which modify the functionality of
                another function".
              </Quote>
              <Cite>http://book.pythontips.com/en/latest/decorators.html</Cite>
            </BlockQuote>
          </Slide>
          <Slide
            transition={['fade']}
            bgColor="black"
            notes="HoC's are just functions"
          >
            <CodePane
              lang="jsx"
          ...
          <Slide
            transition={['fade']}
            bgColor="black"
            notes="That take a component as an argument"
          >
            <CodePane
              lang="jsx"
          ...
          <Slide
            transition={['fade']}
            bgColor="black"
            notes="and return a new component... component in, component out"
          >
            <CodePane
              lang="jsx"
          ...
          <Slide
            transition={['fade']}
            bgColor="black"
            notes="HoCs are not a feature of React. They are just functions that take a component as their argument and return components that wrap them."
          >
            <CodePane
              lang="jsx"
          ...
          <Slide transition={['fade']} bgColor="black">
            <CodePane
              lang="jsx"
              source={require('raw!../assets/hoc5.example')}
              margin="20px auto"
              style={{ fontSize: '20px' }}
            />
          </Slide>
          ...
          >
            <Heading size={6} lineHeight={3} textColor="white">
              Auth example - with different user roles
            </Heading>
            <CodePane
              lang="jsx"
          ...
          <Slide align="center center" transition={['fade']}>
            <Heading size={6} lineHeight={3}>
              HoC's with config options can be written like this:
            </Heading>
            <Code>
              const EnhancedComponent = Enhance(WrappedComponent, config)
            </Code>
            <Heading size={6} lineHeight={3}>
              But they're more often written like:
            </Heading>
            <Code>
              const EnhancedComponent = Enhance(config)(WrappedComponent)
            </Code>
          </Slide>
          <Slide>
            <Heading size={6} lineHeight={3}>
              Why? So they can be composed...
            </Heading>
            <CodePane
              lang="js"
              source={`// compose(f, g, h) is the same as (...args) => f(g(h(...args)))
...
const EnhancedComponent = enhance(WrappedComponent)`}
          ...
          <Slide>
            <Heading size={4} textColor="secondary" margin={40}>
              HoCs you're already using...
            </Heading>
            <CodePane
              lang="js"
              margin="20px auto"
            ...
            <CodePane
              lang="js"
              margin="20px auto"
              source={require('raw!../assets/react-router.example')}
            />
            <CodePane
              lang="js"
              margin="20px auto"
              source={require('raw!../assets/redux-form.example')}
            />
          </Slide>
        </Deck>
      </Spectacle>
